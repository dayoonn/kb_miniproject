...
public class StoreUi {
	public static void main(String[] args) throws StoreException, BuyException {
	...
	private void go() throws StoreException, BuyException {
		init(); // 필요 변수 초기화
//		liststock_store(); // 게시물 목록 출력
	...
	private void mainMenu() throws StoreException, BuyException {
...
//		else if(menu==2) order_store(); //구매하기
	...
	private void listproduct_store() throws StoreException, BuyException {
		...
		try {
			...
			System.out.println("상세보기");
			System.out.println("PRODUCT_ID: " + ddto.getPRODUCT_ID());
			System.out.println("PRODUCT_PRICE: " + ddto.getPRODUCT_PRICE());
			System.out.println("BUY_PRICE: " + ddto.getBUY_PRICE());
		}catch(RecordNotFoundException e) {
			System.out.println("없는 게시물입니다");
		}
