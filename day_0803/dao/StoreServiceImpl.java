...
public class StoreServiceImpl implements StoreService {
	...
	public BuyDto bread(String no) throws BuyException, RecordNotFoundException {
		BuyDto dto = null;
		try {
			dto = buyDao.findById_payid(no);
		} catch (SQLException e) {
			e.printStackTrace();
			throw new BuyException(e.getMessage());
		}
		return dto;
	}
	...
	@Override
	public void add(BuyDto m) throws SQLException, LackQuantityException, SQLException, RecordNotFoundException {
		// TODO Auto-generated method stub
