...
public interface BuyDao {
	...
	//검색
	public BuyDto findById_buynum(int no) throws SQLException, java.sql.SQLException;
	public BuyDto findById_payid(String no) throws SQLException, java.sql.SQLException, ClassNotFoundException;
}
